...
public class MoodParser {
    private static final Map<String, Mood> KEYWORDS = Map.ofEntries(
        ...
        Map.entry("romantic", Mood.HAPPY),
        Map.entry("romance", Mood.HAPPY),
        Map.entry("love", Mood.HAPPY),
        Map.entry("dating", Mood.HAPPY),
        Map.entry("date", Mood.HAPPY),
        Map.entry("couple", Mood.HAPPY),
